...
namespace FullSave_FullSerializer.Internal {
    /// <summary>
    ...
    public class fsMetaProperty {
        internal fsMetaProperty(fsConfig config, FieldInfo field) {
            ...
            CanRead = true;
            CanWrite = true;
            RuntimeSave = field.GetCustomAttribute(typeof(RuntimeSaveAttribute), false) != null;
        ...
        internal fsMetaProperty(fsConfig config, PropertyInfo property) {
            ...
            RuntimeSave = property.GetCustomAttribute(typeof(RuntimeSaveAttribute), false) != null;
            CommonInitialize(config);
        }
        ...
        /// <summary>
        /// Do we ignore this member if mode is set to Editor
        /// </summary>
